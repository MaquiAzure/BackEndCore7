namespace Application.Helper
{
    public class ValidationMessages
    {
        ...
        public const string ConfirmPasswordIsNotEqualWithPassword = "El campo ";

        public const string isRequiredMessage = "El password y su confirmación deben ser iguales.";
    }
}
