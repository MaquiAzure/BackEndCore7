        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreTabla = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdOperacion = table.Column<int>(type: "int", nullable: true),
                    OperacionRealizada = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdRegistro = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValorOriginal = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LasModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
