            ...
            catch (Exception ex)
            {
                ...
                switch (ex)
                {
                    ...
                    case AuthorizationException authorizationException:
                        statusCode = 401;
                        result = JsonConvert.SerializeObject(new CodeErrorResponse(statusCode, authorizationException.Message));
                        break;
                    ...
                    case AuthException authException:
                        statusCode = (int)HttpStatusCode.NotFound;
                        result = JsonConvert.SerializeObject(new CodeErrorException(statusCode, ex.Message, authException.Detail));
                        break;
                    default:
                        break;
                }
